...
CREATE TABLE [tsaat].[spi_applicable_asset_type] (
  ...
  CONSTRAINT [FK_spi_applicable_asset_type_spi]
    FOREIGN KEY ([spi_id]) REFERENCES [tsaat].[spi_definition]([spi_id]) ON DELETE CASCADE,
...
CREATE TABLE [tsaat].[managed_network] (
  ...
  CONSTRAINT [FK_managed_network_snapshot]
    FOREIGN KEY ([snapshot_id]) REFERENCES [tsaat].[dataset_snapshot]([snapshot_id]) ON DELETE CASCADE,
...
CREATE TABLE [tsaat].[ict_system] (
  ...
  CONSTRAINT [FK_ict_system_network]
    FOREIGN KEY ([snapshot_id], [network_id]) REFERENCES [tsaat].[managed_network]([snapshot_id], [network_id]) ON DELETE CASCADE,
...
CREATE TABLE [tsaat].[network_declared_system] (
  ...
  CONSTRAINT [FK_network_declared_system_system]
    FOREIGN KEY ([snapshot_id], [system_id], [network_id]) REFERENCES [tsaat].[ict_system]([snapshot_id], [system_id], [network_id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [tsaat].[system_mission_capability] (
  ...
  CONSTRAINT [FK_system_mission_capability_system]
    FOREIGN KEY ([snapshot_id], [system_id]) REFERENCES [tsaat].[ict_system]([snapshot_id], [system_id]) ON DELETE CASCADE,
...
CREATE TABLE [tsaat].[network_declared_asset] (
  ...
  CONSTRAINT [FK_network_declared_asset_asset]
    FOREIGN KEY ([snapshot_id], [network_id], [asset_id]) REFERENCES [tsaat].[asset]([snapshot_id], [network_id], [asset_id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [tsaat].[system_environment_asset] (
  ...
  CONSTRAINT [FK_system_environment_asset_environment]
    ...
    REFERENCES [tsaat].[system_environment]([snapshot_id], [system_id], [environment_id], [environment_type]) ON DELETE CASCADE,
  CONSTRAINT [FK_system_environment_asset_asset]
    FOREIGN KEY ([snapshot_id], [system_id], [environment_type], [asset_id])
    REFERENCES [tsaat].[asset]([snapshot_id], [system_id], [environment_type], [asset_id]) ON DELETE CASCADE,
...
CREATE TABLE [tsaat].[asset_operating_system] (
  ...
  CONSTRAINT [FK_asset_operating_system_asset]
    FOREIGN KEY ([snapshot_id], [asset_id]) REFERENCES [tsaat].[asset]([snapshot_id], [asset_id]) ON DELETE CASCADE,
...
CREATE TABLE [tsaat].[discovery_tool] (
  ...
  CONSTRAINT [FK_discovery_tool_version]
    FOREIGN KEY ([settings_version_id]) REFERENCES [tsaat].[discovery_tools_settings_version]([settings_version_id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [tsaat].[discovery_tool_asset_scope] (
  ...
  CONSTRAINT [FK_discovery_tool_asset_scope_tool]
    FOREIGN KEY ([settings_version_id], [tool_id]) REFERENCES [tsaat].[discovery_tool]([settings_version_id], [tool_id]) ON DELETE CASCADE,
...
CREATE TABLE [tsaat].[measures_severity_matrix] (
  ...
  CONSTRAINT [FK_measures_severity_matrix_version]
    FOREIGN KEY ([settings_version_id]) REFERENCES [tsaat].[measures_settings_version]([settings_version_id]) ON DELETE CASCADE,
