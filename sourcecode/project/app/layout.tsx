...
const bodyFontClass =
  "font-['Segoe_UI','Trebuchet_MS','Arial',sans-serif]";
const headingFontClass =
  "font-['Bahnschrift','Arial_Narrow','Arial',sans-serif]";
          ...
          <div className="relative left-1/2 w-[min(2100px,calc(100vw-2rem))] -translate-x-1/2 py-4 md:w-[min(2100px,calc(100vw-3rem))]">
            <div className="flex items-center justify-between gap-4">
              <div className="flex shrink-0 items-center gap-3">
                ...
                <div>
                  <p className={`${headingFontClass} text-xl uppercase tracking-[0.14em] text-slate-100`}>
                    TSAAT
                  </p>
