...
const REQUIRED_COLUMNS: Array<{ tableName: string; columnName: string }> = [
  ...
  { tableName: "kpi_definition", columnName: "enabled" },
  { tableName: "kpi_calculation_definition", columnName: "source_key" },
  { tableName: "kpi_report_detail_definition", columnName: "handler_key" },
  { tableName: "kpi_tasking_team", columnName: "support_queue" },
  { tableName: "kpi_tasking_action_template", columnName: "condition_key" },
  { tableName: "kpi_tasking_condition_template", columnName: "template_text" },
  { tableName: "finding_severity_definition", columnName: "selectable_in_settings" },
  { tableName: "finding_priority_definition", columnName: "priority_rank" },
  { tableName: "finding_priority_definition", columnName: "selectable_in_settings" },
  { tableName: "finding_source_policy", columnName: "use_persisted_findings" },
  { tableName: "finding_generation_policy", columnName: "history_start_date" },
  { tableName: "finding_workflow_status_definition", columnName: "tone_key" },
  { tableName: "finding_bucket_definition", columnName: "condition_key" },
  { tableName: "finding_evidence_field_definition", columnName: "candidate_keys_json" },
  { tableName: "finding_register_column_definition", columnName: "value_key" },
  { tableName: "spi_definition", columnName: "display_order" },
  { tableName: "spi_definition", columnName: "rule_key" },
  { tableName: "spi_definition", columnName: "default_severity" },
  { tableName: "spi_definition", columnName: "report_available" },
  { tableName: "spi_rule_definition", columnName: "handler_key" },
  { tableName: "spi_rule_parameter_definition", columnName: "allowed_values_json" },
  { tableName: "spi_rule_outcome_template", columnName: "reason_template" },
  { tableName: "spi_report_detail_definition", columnName: "handler_key" },
  { tableName: "spi_calculation_source", columnName: "source_object_name" },
  { tableName: "spi_calculation_definition", columnName: "status_expression_sql" },
  { tableName: "spi_calculation_definition", columnName: "outcome_expression_sql" },
  { tableName: "spi_calculation_evidence_expression", columnName: "value_expression_sql" },
  { tableName: "spi_feature_binding", columnName: "feature_key" },
  { tableName: "spi_finding_classification_rule", columnName: "condition_key" },
  { tableName: "spi_rule_parameter", columnName: "parameter_key" },
  { tableName: "spi_tasking_team", columnName: "support_queue" },
  { tableName: "spi_tasking_action_template", columnName: "condition_key" },
  { tableName: "spi_tasking_condition_template", columnName: "template_text" },
  { tableName: "discovery_tool", columnName: "tool_id" },
  { tableName: "discovery_tool_detection_rule", columnName: "condition_key" },
